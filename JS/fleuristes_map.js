...
function addStoreMarker(store) {
    // Ajoutez une condition pour vérifier si la catégorie est égale à "Fleuriste"
    if (store.category === "Fleuriste") {
        var rosePointerIcon = L.icon({
        ...
        // Ajoutez un événement de survol pour afficher la pop-up lorsque vous survolez le marqueur
        ...
        // Ajoutez un événement de survol pour fermer la pop-up lorsque vous quittez le marqueur
