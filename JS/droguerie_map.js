...
function addStoreMarker(store) {
  // Ajoutez une condition pour vérifier si la catégorie est égale à "Droguerie"
  if (store.category === "Droguerie") {
    var bluePointerIcon = L.icon({
