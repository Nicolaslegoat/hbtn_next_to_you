...
function addStoreMarker(store) {
    // Ajoutez une condition pour vérifier si la catégorie est égale à "Fromagerie"
    if (store.category === "Fromagerie") {
      var yellowPointerIcon = L.icon({
