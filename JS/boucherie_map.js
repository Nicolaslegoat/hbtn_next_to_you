...
function addStoreMarker(store) {
    // Ajoutez une condition pour vérifier si la catégorie est égale à "Boucherie"
    if (store.category === "Boucherie") {
        // Utilisez votre image SVG pour le marqueur
        var redPointerIcon = L.icon({
